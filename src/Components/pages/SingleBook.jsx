...
function SingleBook( { book, handleSelected, selected, goToBookDetails }) {
  ...
  return (
    <Col xs={12} md={6} lg={4} xxl={3}>
      ...
      <Card className={ darkMode ? "bg-black book-cover d-flex flex-column text-white p-3 mb-3 border rounded" : "bg-secondary-subtle book-cover d-flex flex-column p-3 mb-3 border rounded border-black"} data-testid='book-card'>
